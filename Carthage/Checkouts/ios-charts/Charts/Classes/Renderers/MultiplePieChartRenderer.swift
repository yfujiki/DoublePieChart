...
public class MultiplePieChartRenderer: PieChartRenderer {
    ...
    public func drawDataSet(#context: CGContext, dataSet: PieChartDataSet, setIndex: Int)
    {
        ...
        var factor = (CGFloat(3) + (CGFloat(setIndex + 1) / CGFloat(_chart.data!.dataSetCount))) / CGFloat(4)
        var radius = _chart.radius * factor
